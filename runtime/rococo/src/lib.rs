...
use frame_support::{
	...
	traits::{
		AsEnsureOriginWithArg, Contains, EitherOfDiverse, InstanceFilter, KeyOwnerProofSystem, LockIdentifier,
...
parameter_types! {
	pub const AssetDeposit: Balance = 100 * GRAND;
	pub const ApprovalDeposit: Balance = 1 * GRAND;
	pub const StringLimit: u32 = 50;
	pub const MetadataDepositBase: Balance = 10 * GRAND;
	pub const MetadataDepositPerByte: Balance = 1 * GRAND;
}
...
impl pallet_assets::Config for Runtime {
	...
	type AssetAccountDeposit = ConstU128<GRAND>;
